        ...
        <Layout title="Register - NexGen">
            <div className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="form-control" id="exampleInputNumber1" placeholder='Enter your Number' required />
                    </div>
                    <div className="mb-3">
